...
singularity run /sw/containers/plink-1.90b6.21.sif plink1.9 --vcf callsfilt_ef.vcf --indep 50 5 2 --allow-extra-chr
...
singularity run /sw/containers/plink-1.90b6.21.sif plink1.9 --vcf callsfilt_ef.vcf --extract plink.prune.in --make-bed --out pruneddataef --allow-extra-chr
